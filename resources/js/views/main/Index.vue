                  ...
                  <div class="row align-items-center justify-content-start w-100 h-100">
                    <div class="col-xl-6 col-md-9">
                      <div class="content-common home3c slideup position-relative">
                        ...
                        <p class="text wow animated fadeInUp text-white-50">
          ...
          <div class="row mt--30">
            <div class="col-lg-6 h-100 mt-30">
              <a href="shop-grid.html" class="catagory-single one home3cat">
                <img src="/assets/images/home-three/iphon13_1.jpg" alt="#" class="background-img bg-img imgone">
                <div class="content">
                ...
                <div class="catagory-slider-three">
                    ...
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="/assets/images/home-three/iphone13.jpg" class="first-img"
                               alt="" />
                      ...
                      <div class="products-three-single-content text-center"> <span>Phone</span>
                        <h5><a href="shop-details-3.html">Iphone 13 Pro </a></h5>
                        <p>₽79990.0</p>
                      </div>
                    </div>
                  </div>
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="/assets/images/home-three/canon5d.jpg" alt="" />
                        </a>
                      ...
                      <div class="products-three-single-content text-center"> <span>Fotocamera</span>
                        <h5><a href="shop-details-3.html">Cannon 5D</a></h5>
                        <p>₽109990</p>
                      </div>
                    </div>
                  </div>
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="/assets/images/home-three/MacBook14.jpg" class="first-img"
                               alt="" />
                      ...
                      <div class="products-three-single-content text-center"> <span>Laptop</span>
                        <h5><a href="shop-details-3.html">MacBook 14</a></h5>
                        <p>₽234990</p>
                      </div>
                    </div>
                  </div>
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="/assets/images/home-three/google-pixel7-pro-2.jpg" alt="" />
                        </a>
                      ...
                      <div class="products-three-single-content text-center"> <span>Phone</span>
                        <h5><a href="shop-details-3.html">Google Pixel 7 Pro</a></h5>
                        <p>₽56990</p>
                      </div>
                    </div>
                  </div>
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img img-bg">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="/assets/images/home-three/sonyA7.jpg" alt="" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                      ...
                      <div class="products-three-single-content text-center"> <span>Fotocamera</span>
                        <h5><a href="shop-details-3.html">Sony A7</a></h5>
                        <p>₽29990</p>
                      </div>
                    </div>
                  </div>
                  <div class="products-three__inner">
                    <div class="products-three-single w-100">
                      <div class="products-three-single-img">
                        <a href="shop-details-3.html" class="d-block">
                          <img src="/assets/images/home-three/samsungNote23.png" alt="" />
                        </a>
                        <div class="products-grid-one__badge-box"> <span
                            class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                                                            class="addcart btn--primary style2"> Add To Cart </a>
                      ...
                      <div class="products-three-single-content text-center"> <span>Phone</span>
                        <h5><a href="shop-details-3.html">Samsung Note 23</a></h5>
                        <p><del>₽149990</del> ₽99990</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xl-6 wow fadeInLeft animated ">
              <div class="video-main-box position-relative">
                <div class="video-two__img"
                     style="background-image: url(/assets/images/home-three/tehnical.jpg);">
              ...
              <div class="product-slider-main position-relative ">
                <div class="product-slider__single text-center">
                  <div
                    ...
                    <div class="img-box">
                      <img src="/assets/images/home-three/iphone12Pro_1.png" alt="" />
                    </div>
                    <div class="content-box mt-4"> <span>On Sale</span>
                      <h2>₽79990</h2>
                      <h5>Получи 15% на твой первый заказ</h5>
                ...
                <div class="product-slider__single text-center">
                  <div
                      class="inner text-center d-flex flex-column justify-content-center align-items-center">
                    <div class="img-box">
                      <img src="/assets/images/home-three/ipadMini6.png" alt="" />
                    </div>
                    <div class="content-box mt-4"> <span>On Sale</span>
                      <h2>₽35590</h2>
                      <h5>Получи 15% на твой первый заказ</h5>
                ...
                <div class="product-slider__single text-center">
                  <div
                      class="inner text-center d-flex flex-column justify-content-center align-items-center">
                    <div class="img-box">
                      <img src="/assets/images/home-three/s22.png" alt="" />
                    </div>
                    <div class="content-box mt-4"> <span>On Sale</span>
                      <h2>₽49990</h2>
                      <h5>Получи 15% на твой первый заказ</h5>
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-md-6 wow fadeInUp animated">
                <div class="products-cetagory-three__single">
                  <div class="products-cetagory-three__single-img height-400"
                       style="background-image: url(/assets/images/shop/ipad6.jpg);"> </div>
                  <div class="products-cetagory-three__single-content "> <span>Ipad Mini 6</span>
                    <h2>2021 Device</h2>
                    <div class="text">
                      <p>Магия Ipad <br>у вас на ладони.</p>
                    </div>
              ...
              <div class="col-xxl-3 col-md-6 wow fadeInUp animated">
                <div class="products-cetagory-three__single style3">
                  <div class="products-cetagory-three__single-img  height-400  "
                       style="background-image: url(/assets/images/shop/ipad-pro_specs__fg0b6vj9mu6i_og.png);"> </div>
                  <div class="products-cetagory-three__single-content "> <span>Ipad Pro</span>
                    <h2>2022 Device</h2>
                    <div class="text">
                      <p>Ipad Pro <br> superpower with chip apple m1</p>
                    </div>
